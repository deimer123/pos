...
class ConfiguracionEmpresa extends Model
{
    ...
    protected $fillable = [
        ...
        'usa_mesas',
        'usa_cocina',
        'imprime_comanda_en_lugar_de_cocina',
        'usa_recetas',
        'porcentaje_propina',
        ...
        'catalogo_mostrar_stock_positivo',
        'catalogo_mostrar_stock_negativo',
        'prefijo',
        'rango_desde',
        'rango_hasta',
        'rango_actual',
    ...
    protected $casts = [
        ...
        'usa_mesas' => 'boolean',
        'usa_cocina' => 'boolean',
        'imprime_comanda_en_lugar_de_cocina' => 'boolean',
        'usa_recetas' => 'boolean',
        ...
        'catalogo_mostrar_precio' => 'boolean',
        'catalogo_mostrar_stock_positivo' => 'boolean',
        'catalogo_mostrar_stock_negativo' => 'boolean',

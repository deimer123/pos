...
namespace App\Filament\Resources\ReporteTecnicosResource\Widgets;

use App\Filament\Resources\ReporteTecnicosResource\Pages\ListReporteTecnicos;
use Filament\Widgets\Concerns\InteractsWithPageTable;
use Filament\Widgets\StatsOverviewWidget as BaseWidget;
use Filament\Widgets\StatsOverviewWidget\Stat;
use Illuminate\Support\Facades\DB;

class ReporteTecnicosStats extends BaseWidget
{
    use InteractsWithPageTable;

    protected function getTablePage(): string
    {
        return ListReporteTecnicos::class;
    }
    ...
    protected function getStats(): array
    {
        ...
        $montoTecnico    = (float) $registros->sum(fn ($r) => $r->valor_tercero);
        ...
        return [
            ...
            Stat::make('Le ha quedado a él', $this->money($montoTecnico))

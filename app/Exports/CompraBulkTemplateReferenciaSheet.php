...
class CompraBulkTemplateReferenciaSheet implements FromArray, WithHeadings, WithTitle, WithColumnWidths, WithStyles
{
    ...
    public function array(): array
    {
        $instrucciones = [
            ...
            'Descuento Comercial NO se llena solo: se escribe a mano en cada fila (0 si no aplica). Afecta el costo real de esta compra sin importar si el producto es nuevo o ya existia.',
            'Departamento, Subfamilia y Unidad de Medida tampoco se llenan solos, pero solo importan si el producto es nuevo (si ya existia, no se tocan al importar).',
            'Utilidad la escribes tu (es una decision de precio de esta compra, no se copia del historico). Precio de Venta se calcula a partir de Costo con el Descuento Comercial ya aplicado, mas IVA, mas Utilidad, redondeado a la centena -- no hace falta escribirlo.',

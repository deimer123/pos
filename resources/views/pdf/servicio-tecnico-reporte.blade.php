...
<div class="header">
    ...
    <div style="font-size:14px; font-weight:700; color:#374151; margin-top:4px;">Reporte de Órdenes de Servicio Técnico</div>
    <div class="sub">
...
@php
    ...
    $granTotal = $query->sum(fn($o) => $o->items->sum('subtotal'));
@endphp
...
<table>
    <thead>
        <tr>
            ...
            <th>Cliente</th>
            <th style="width:90px;">IMEI/Serial</th>
            <th>Equipo</th>
    ...
    <tbody>
        ...
        @php $totalOrden = $orden->items->sum('subtotal'); @endphp
        <tr class="{{ $i % 2 === 1 ? 'tr-par' : '' }}">
            ...
            <td style="font-weight:800; color:#0f766e; font-size:10px;">{{ $orden->imei_serial ?: '—' }}</td>
            <td>

        ...
        @forelse ($products as $product)
            ...
            <div wire:key="producto-{{ $product->id_producto }}" class="h-full">
                <div
                    ...
                    <div class="grid h-full justify-items-center px-3 py-3 text-center" style="min-height: 244px; grid-template-rows: 24px 52px 54px 42px 58px;">
                        ...
                        <div class="flex h-[50px] w-full items-center justify-center self-center overflow-hidden px-1">
                            <div title="{{ $product->descripcion_larga }}"
                                class="h-[50px] w-full overflow-hidden text-center text-[8px] leading-[1.02] text-slate-700 break-words cursor-default"
                        ...
                        <div class="relative z-10 flex h-[58px] w-full flex-col items-center justify-center self-center gap-1.5 bg-white">
                ...
                <div
                    ...
                    <div class="flex h-full flex-col items-center px-2 py-2.5 text-center" style="min-height: 168px;">
                        ...
                        <div class="mt-1 flex w-full min-h-[2.5rem] items-center justify-center overflow-hidden px-1">
                            <div title="{{ $product->descripcion_larga }}"
                                class="h-[2.5rem] overflow-hidden text-center text-[7px] leading-[1] text-slate-700 break-words cursor-default"
                                style="display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; text-overflow: ellipsis;">
                                {{ $product->descripcion_larga }}
                            </div>
                        </div>
                        ...
                        <div class="relative z-10 mt-1 flex w-full flex-col items-center gap-1 bg-white">
                            <button wire:click="agregarAlCarrito({{ $product->id_producto }})"
                                class="w-[84px] bg-indigo-600 hover:bg-indigo-700 text-white px-2 py-1 text-[11px] rounded-full shadow">
                                Agregar
                            </button>

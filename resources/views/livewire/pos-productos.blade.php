            ...
            <div wire:key="producto-{{ $product->id_producto }}" class="h-full">
                <div
                    ...
                    <div class="grid h-full justify-items-center px-3 py-3 text-center" style="min-height: 244px; grid-template-rows: 24px 52px 60px 42px 58px;">
                        ...
                        <div class="flex h-[48px] items-center justify-center self-center">
                        ...
                        <div class="flex h-[56px] w-full items-center justify-center self-center overflow-hidden px-1">
                            <div title="{{ $product->descripcion_larga }}"
                                class="w-full max-h-[56px] overflow-hidden text-center text-[8px] leading-[1.02] text-slate-700 break-words cursor-default"
                                style="display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; text-overflow: ellipsis;">
                        ...
                        <div class="flex h-[58px] w-full flex-col items-center justify-center self-center gap-1.5">
                ...
                <div
                    ...
                    <div class="flex h-full flex-col items-center px-2 py-2.5 text-center" style="min-height: 168px;">
                        ...
                        <div class="mt-1 flex w-full min-h-[2.8rem] items-center justify-center overflow-hidden px-1">
                            <div title="{{ $product->descripcion_larga }}"
                                class="max-h-[2.8rem] overflow-hidden text-center text-[7px] leading-[1] text-slate-700 break-words cursor-default"
                                style="display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; text-overflow: ellipsis;">
                                {{ $product->descripcion_larga }}
                            </div>
                        </div>

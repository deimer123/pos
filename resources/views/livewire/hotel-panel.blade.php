                ...
                <div style="background:#fffbeb; border:1px solid #fde68a; border-radius:8px; padding:12px; margin-bottom:12px;" x-data="{
                    ...
                    <div style="font-size:9px; color:#92400e; margin-top:4px;">
                        @if($resInmediato)
                            ...
                            @if($this->precioNocheReserva > 0)
                                Máximo ${{ number_format($this->precioNocheReserva, 0, ',', '.') }} (el valor de la habitación en este momento).
                            @endif
                        @else
                            ...
                            @if($this->totalEstimadoReserva > 0)
                                Máximo ${{ number_format($this->totalEstimadoReserva, 0, ',', '.') }} (el total estimado).
                            @endif
                        @endif
                    </div>
                </div>

...
<head>
    <meta charset="utf-8">
    <title>Activar Sistema POS Local</title>
    <style>
        html, body {
...
<body>
    <div class="card">
        <h1>Activar esta instalación</h1>
        <p class="sub">Esta es una instalación 100% local: no se sincroniza nunca con ningún servidor. Se activa una sola vez con un código emitido para esta empresa y esta máquina.</p>

        <div class="machine-id-box">
            <div class="valor">{{ $machineId ?: 'No se pudo calcular' }}</div>
            <div class="ayuda">Este es el identificador de esta máquina. Envíalo a quien te vendió el sistema para que te emita el código de activación.</div>
        </div>
